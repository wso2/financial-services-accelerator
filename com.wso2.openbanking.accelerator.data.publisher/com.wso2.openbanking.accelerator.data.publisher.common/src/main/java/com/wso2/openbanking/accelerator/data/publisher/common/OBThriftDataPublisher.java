...
import com.wso2.openbanking.accelerator.common.constant.FinancialServicesConstants;
 ...
 */
public class OBThriftDataPublisher implements FinancialServicesDataPublisher {
    ...
    protected void init() {
        ...
        attributeValidationMap = OBAnalyticsDataHolder.getInstance().getFinancialServicesConfigurationService()
    ...
    private boolean validateAttributes(String streamName, List<String> attributes, Map<String, Object> analyticsData) {
        ...
        for (String attribute: attributes) {
            ...
            String type = (String) attributeValidations.get(attributeNameKey).get(FinancialServicesConstants.ATTRIBUTE_TYPE);
