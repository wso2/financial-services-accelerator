...
import AccountInformationConsentDetailsDataShared from "./utils/AccountInformationConsentDetailsDataShared";
import { useParams } from "react-router-dom";

// Utils
import { AccountInformationPageTableData } from "../../../utils/mock/AccountInformationTableMockData";

function AccountInformationCosentDetailsPage() {
  // State
  ...
  const consent = AccountInformationPageTableData.filter(
    (item) => item.id === ID
  )[0];
  ...
  return (
    <div className="accountInformationConsentDetailsPage">
      ...
      >
        ...
        <AccountInformationConsentDetailsDataShared />
        {/* Popup */}
        <div>
          <Popup visible={displayPopup} setVisible={setDisplayPopup}>
            <ConsentDetailsPopup
              consent={consent}
              dataShared={<AccountInformationConsentDetailsDataShared />}
            />
          </Popup>
        </div>
      </ConsentDetails>
...
export default AccountInformationCosentDetailsPage;
