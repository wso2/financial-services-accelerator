 ...
 */
    ...
    PayloadGenerator addGrantType(String grantType = null) {
        ...
        if (gType == null) {
            gType = Constants.CLIENT_CREDENTIALS
        }
        sb.append(Constants.GRANT_TYPE_KEY + "=" + gType + delimiter)
        return this
    }
    ...
    PayloadGenerator addScopes(List<String> scopes = null) {
        ...
        if (scopesList == null) {
            scopesList = Constants.ACCOUNTS_DEFAULT_SCOPES
        }
        sb.append(Constants.SCOPE_KEY + "=" + CommonTestUtil.getParamListAsString(scopesList, ' ') + delimiter)
        return this
    }
    ...
    PayloadGenerator addClientAsType(String type = null) {
        ...
        if (clientAsType == null) {
            clientAsType = Constants.CLIENT_ASSERTION_TYPE
        }
        sb.append(Constants.CLIENT_ASSERTION_TYPE_KEY + "=" + clientAsType + delimiter)
        return this
    }
    ...
    PayloadGenerator addRedirectUri(String redirectURI = null) {
        ...
        sb.append(Constants.REDIRECT_URI_KEY + "=" + redirect + delimiter)
        return this
    }
    ...
    PayloadGenerator addClientID(String client = null) {
        ...
        sb.append(Constants.CLIENT_ID_KEY + "=" + clientID + delimiter)
        return this
    }
    ...
    PayloadGenerator addClientAssertion(String clientAssertion) {
        sb.append(Constants.CLIENT_ASSERTION_KEY + "=" + clientAssertion + delimiter)
        return this
    }
    ...
    PayloadGenerator addUserName(String userName) {
        sb.append(Constants.USER_NAME + "=" + userName + delimiter)
        return this
    }
    ...
    PayloadGenerator addPassword(String pwd) {
        sb.append(Constants.PASSWORD + "=" + pwd + delimiter)
        return this
    }
    ...
    PayloadGenerator addRefreshToken(String rToken) {
        sb.append(Constants.REFRESH_TOKEN + "=" + rToken + delimiter)
        return this
    }
    ...
    PayloadGenerator addCode(String code) {
        sb.append(Constants.CODE_KEY + "=" + code + delimiter)
        return this
    }
    ...
    PayloadGenerator addCodeVerifier(String codeVerifier) {
        sb.append(Constants.CODE_VERIFIER_KEY + "=" + codeVerifier + delimiter)
        return this
    }
