...
class JSONRequestGenerator {
    ...
    JSONRequestGenerator addIssuer(String clientID = null) {
        ...
        payload.put(Constants.ISSUER_KEY, id)
        return this
    }
    ...
    JSONRequestGenerator addSubject(String clientID = null) {
        ...
        payload.put(Constants.SUBJECT_KEY, id)
        return this
    }
    ...
    JSONRequestGenerator addAudience(String aud = null) {
        ...
        payload.put(Constants.AUDIENCE_KEY, audience)
        return this
    }
    ...
    JSONRequestGenerator addExpireDate(Long expDate = null) {
        ...
        payload.put(Constants.EXPIRE_DATE_KEY, exp)
        return this
    }
    ...
    JSONRequestGenerator addIssuedAt() {
        ...
        payload.put(Constants.ISSUED_AT_KEY, iat)
        return this
    }
    ...
    JSONRequestGenerator addJti(String jtiValue = null) {
        ...
        payload.put(Constants.JTI_KEY, jti)
        return this
    }
    ...
    JSONRequestGenerator addResponseType(String type = null) {
        String resType = type
        if (resType == null) {
            resType = Constants.AUTH_RESPONSE_TYPE
        }
        payload.put(Constants.AUTH_RESPONSE_TYPE_KEY, resType)
        return this
    }
    ...
    JSONRequestGenerator addClientID(String client = null) {
        ...
        payload.put(Constants.CLIENT_ID_KEY, clientID)
        return this
    }
    ...
    JSONRequestGenerator addRedirectURI(String uri = null) {
        ...
        payload.put(Constants.REDIRECT_URI_KEY, redirectURI)
        return this
    }
    ...
    JSONRequestGenerator addScope(String scope) {
        payload.put(Constants.SCOPE_KEY, scope)
        return this
    }
    ...
    JSONRequestGenerator addState(String state) {
        payload.put(Constants.STATE_KEY, state)
        return this
    }
    ...
    JSONRequestGenerator addNonce(String nonce = null) {
        ...
        payload.put(Constants.NONCE_KEY, nonceString)
        return this
    }
