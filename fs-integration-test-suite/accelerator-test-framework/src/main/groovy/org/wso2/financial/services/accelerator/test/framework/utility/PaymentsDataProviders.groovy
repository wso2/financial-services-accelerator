...
class PaymentsDataProviders {
    ...
    @DataProvider(name = "jwsHeadersWithMissingCriticalClaims")
    Iterator<String> jwsHeadersWithMissingCriticalClaims() {
    ...
    @DataProvider(name = "jwsHeadersWithInvalidClaims")
    Iterator<String> jwsHeadersWithInvalidClaims() {
