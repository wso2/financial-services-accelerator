...
class DCREndToEndFlow extends FSConnectorTest {
    ...
    void "TC0101001_Invoke registration request"() {
    ...
    @Test (groups = "SmokeTest", dependsOnMethods = "TC0101001_Invoke registration request")
    void "TC0102001_Retrieve registration details with a valid clientId and access token"() {
    ...
    @Test(groups = "SmokeTest", dependsOnMethods = "TC0102001_Retrieve registration details with a valid clientId and access token")
    void "TC0103001_Update client request with a valid details"() {
    ...
    @Test (groups = "SmokeTest", dependsOnMethods = "TC0103001_Update client request with a valid details")
    void "TC0104004_Delete client with a valid clientId and access token"() {
