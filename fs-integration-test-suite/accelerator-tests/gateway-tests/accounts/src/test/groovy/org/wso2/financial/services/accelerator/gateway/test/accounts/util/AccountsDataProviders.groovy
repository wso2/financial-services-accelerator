...
class AccountsDataProviders {
    ...
    Object[] getInvalidAccountsPermissionsForInitiation() {
        ...
        invalidPermissions.add([ConnectorTestConstants.READ_ACCOUNTS_DETAIL, "xyz"] as Object)
        invalidPermissions.add([ConnectorTestConstants.INVALID_PERMISSION] as Object)
