 ...
 */
class DCREndToEndFlowJSONPayload extends FSConnectorTest {
    ...
    void "Invoke registration request structured as a JSON"() {

        def registrationResponse = RestAsRequestBuilder.buildBasicRequest()
    ...
    @Test(groups = "SmokeTest", dependsOnMethods = "Invoke registration request structured as a JSON")
    ...
    void "Update client request with a valid details"() {
        ...
        def registrationResponse = RestAsRequestBuilder.buildBasicRequest()
                .contentType("application/json")
                .header("Authorization", "Bearer " + accessToken)
                .body(ClientRegistrationRequestBuilder.getUpdateRegularClaimsForGateway(SSA))
                .accept("application/json")
