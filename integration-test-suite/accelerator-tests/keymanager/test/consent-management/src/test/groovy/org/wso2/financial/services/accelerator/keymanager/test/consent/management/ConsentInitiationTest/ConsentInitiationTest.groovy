...
package org.wso2.financial.services.accelerator.keymanager.test.consent.management.ConsentInitiationTest
 ...
 */
class ConsentInitiationTest extends FSAcceleratorTest {
    ...
    void "OB-1951_Verify Creation of a consent without Content Type Header"() {
        ...
        Assert.assertEquals(consentResponse.getStatusCode(), AcceleratorTestConstants.STATUS_CODE_415)
    }
    ...
    void "OB-1955_Verify Creation of a consent without ReadAccountsDetail permission"() {
        ...
        consentValidateResponse = FSRestAsRequestBuilder.buildRequest()
                ...
                .body(signedObject.getSignedRequest(RequestPayloads.buildValidationAccountsPayload(GenerateBasicHeader(),
                        userId, consentId)))
                .header(AcceleratorTestConstants.AUTHORIZATION_HEADER, consentRequestBuilder.GenerateBasicHeader())
    ...
    void "Verify Creation of a consent without client ID"() {
        ...
        Assert.assertEquals(consentResponse.getStatusCode(), AcceleratorTestConstants.STATUS_CODE_400)
        Assert.assertEquals(TestUtil.parseResponseBody(consentResponse, AcceleratorTestConstants.ERROR_ERRORS_DESCRIPTION),
