 ...
 */
class SignatureAlgorithmValidationTest extends FSAcceleratorTest {
    ...
    void "OB-497_Validate token request contains client assertion signed with unsupported signature algorithm"() {
        ...
        String jwt = acceleratorJWTGenerator.getUserAccessTokenJwt(AcceleratorTestConstants.PKJWT_AUTH_METHOD, clientId, code)
