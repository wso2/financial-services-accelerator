...
class AccountPayloads {
    ...
    static String[] permissionsArray = [
            AcceleratorTestConstants.READ_ACCOUNTS_BASIC,
            AcceleratorTestConstants.READ_ACCOUNTS_DETAIL,
            AcceleratorTestConstants.READ_BALANCES,
            AcceleratorTestConstants.READ_TRANSACTIONS_DETAIL
    ]
    ...
    public static String initiationPayloadWithInvalidExpirationDate = """
        {
            "Data":{
            "Permissions": ${JsonOutput.toJson(permissionsArray)},
            "ExpirationDateTime":"${AcceleratorTestConstants.fromInstant.toEpochSecond()}",
            "TransactionFromDateTime":"${AcceleratorTestConstants.fromInstant}",
            "TransactionToDateTime":"${AcceleratorTestConstants.toInstant}"
        },
            "Risk":{
    ...
    public static String initiationPayloadWithoutTransactionToDate = """
        {
            "Data":{
            "Permissions": ${JsonOutput.toJson(permissionsArray)},
            "ExpirationDateTime":"${AcceleratorTestConstants.expirationInstant}",
            "TransactionFromDateTime":"${AcceleratorTestConstants.fromInstant}",
            "Risk":{
    ...
    public static String initiationPayloadWithInvalidTransactionToDate = """
        {
            ...
            "ExpirationDateTime":"${AcceleratorTestConstants.expirationInstant}",
            "TransactionFromDateTime":"${AcceleratorTestConstants.fromInstant}",
            "TransactionToDateTime":"${AcceleratorTestConstants.toInstant.toEpochSecond()}"
        },
            "Risk":{
    ...
    public static String initiationPayloadWithInvalidTransactionFromDate = """
        {
            ...
            "Permissions": ${JsonOutput.toJson(permissionsArray)},
            "ExpirationDateTime":"${AcceleratorTestConstants.expirationInstant}",
            "TransactionFromDateTime":"${AcceleratorTestConstants.fromInstant.toEpochSecond()}",
            "TransactionToDateTime":"${AcceleratorTestConstants.toInstant}"
        },
            "Risk":{
    ...
    public static String initiationPayloadWithSameTransactionFromToDates = """
            {
                ...
                "ExpirationDateTime":"${AcceleratorTestConstants.expirationInstant}",
                "TransactionFromDateTime":"${AcceleratorTestConstants.fromInstant}",
                "TransactionToDateTime":"${AcceleratorTestConstants.fromInstant}"
            },
                "Risk":{
