 ...
 */
class AbstractAccountsFlow extends FSAcceleratorTest {
    ...
    List<AcceleratorTestConstants.ApiScope> scopeList = ConsentMgtTestUtils.getApiScopesForConsentType(AcceleratorTestConstants.ACCOUNTS_TYPE)
    ...
    void setup() {
        applicationAccessToken = getApplicationAccessToken(AcceleratorTestConstants.PKJWT_AUTH_METHOD,
    ...
    void doDefaultAccountInitiation() {
        ...
        consentStatus = TestUtil.parseResponseBody(consentResponse, AcceleratorTestConstants.DATA_STATUS)
    }
    ...
    void doAccountConsentAuthorisation() {
        ...
        userAccessToken = getUserAccessToken(AcceleratorTestConstants.PKJWT_AUTH_METHOD,
