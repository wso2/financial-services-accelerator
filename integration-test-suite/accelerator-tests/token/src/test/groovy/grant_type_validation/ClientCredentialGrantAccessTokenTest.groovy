 ...
 */
class ClientCredentialGrantAccessTokenTest extends FSAcceleratorTest {
    ...
    void "Validate token request for client with token_endpoint_auth_method tls_client_auth"() {
        ...
        Response tokenResponse = getApplicationAccessTokenResponse(AcceleratorTestConstants.TLS_AUTH_METHOD,
                clientId, [scope])
