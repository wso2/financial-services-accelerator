    ...
    public static String initiationIncorrectPayload = """
            {
                ...
                "Permissions": ${JsonOutput.toJson(permissionsArray)},
                "ExpirationDateTime":"${AcceleratorTestConstants.expirationInstant}",
                "TransactionFromDate":"${AcceleratorTestConstants.fromInstant}",
                "TransactionToDateTime":"${AcceleratorTestConstants.toInstant}"
            },
                "Risk":{
    ...
    public static String initiationPayloadWithInvalidDate = """
            {
                "Data":{
                "Permissions": ${JsonOutput.toJson(permissionsArray)},
                "ExpirationDateTime":"${AcceleratorTestConstants.expirationInstant.toEpochSecond()}",
                "TransactionFromDateTime":"${AcceleratorTestConstants.fromInstant}",
                "TransactionToDateTime":"${AcceleratorTestConstants.toInstant}"
            },
                "Risk":{
...
""".stripIndent()
    ...
    public static String initiationPayloadWithoutArrayFormat = """
            {
                "Data":{
                "Permissions": ${JsonOutput.toJson(AcceleratorTestConstants.READ_ACCOUNTS_DETAIL)},
                "ExpirationDateTime":"${AcceleratorTestConstants.expirationInstant}",
                "TransactionFromDateTime":"${AcceleratorTestConstants.fromInstant}",
                "TransactionToDateTime":"${AcceleratorTestConstants.toInstant}"
            },
    ...
    public static String getParameterValue(String parameter, def parameterMap) {
        ...
        if (parameterMap.containsKey(parameter)) {
            ...
            if (parameter == "RequestedExecutionDateTime") {
                ...
                return DateTimeFormatter.ISO_INSTANT.format(AcceleratorTestConstants.DATE_TIME)
            } else {
