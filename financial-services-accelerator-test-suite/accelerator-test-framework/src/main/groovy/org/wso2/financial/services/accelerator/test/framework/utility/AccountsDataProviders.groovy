...
class AccountsDataProviders {
    ...
    Object[] getInvalidAccountsPermissionsForInitiation() {
        ...
        invalidPermissions.add([ConnectorTestConstants.READ_ACCOUNTS_BASIC, ConnectorTestConstants.READ_TRANSACTIONS_DETAIL] as Object)
        invalidPermissions.add([ConnectorTestConstants.READ_ACCOUNTS_BASIC, ConnectorTestConstants.READ_TRANSACTIONS_CREDITS] as Object)
        invalidPermissions.add([ConnectorTestConstants.READ_ACCOUNTS_BASIC, ConnectorTestConstants.READ_TRANSACTIONS_DEBITS] as Object)
