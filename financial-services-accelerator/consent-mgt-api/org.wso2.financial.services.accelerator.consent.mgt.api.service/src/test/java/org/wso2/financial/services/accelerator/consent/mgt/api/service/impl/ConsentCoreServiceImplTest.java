...
import org.wso2.financial.services.accelerator.consent.mgt.api.service.util.ConsentMgtServiceTestData;
...
//    }
    ...
    // unit test for consentStatusBulkUpdate
    @Test
    public void testBulkUpdateConsentStatus() throws
        ...
        consentCoreServiceImpl.consentStatusBulkUpdate(ConsentMgtServiceTestData.ORG_ID,
    ...
    // unit test for consentStatusBulkUpdate with exceptions
    @Test(expectedExceptions = ConsentMgtException.class)
...
//    }
    ...
    public void testGetConsentStatusAuditRecords() throws
        ...
        doReturn(consentStatusAuditRecords).when(mockedConsentCoreDAO)
                .getConsentStatusAuditRecordsByConsentId(any(), any(ArrayList.class),
                        anyInt(),
                        anyInt());
        List<ConsentStatusAuditRecord> statusAuditRecords =
    ...
    public void testDeleteConsent() throws
            Exception {
        // Mock DAO behavior
        doNothing().when(mockedConsentCoreDAO).deleteConsent(any(), any(), any());
    ...
    public void testDeleteConsentWithException() throws
        ...
        // Call the method
        consentCoreServiceImpl.deleteConsent(ConsentMgtServiceTestData.CONSENT_ID, ConsentMgtServiceTestData.ORG_ID);
    }
