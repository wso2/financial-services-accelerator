...
package org.wso2.financial.services.accelerator.consent.mgt.api.dao.queries;
...
public class ConsentMgtCommonDBQueries {
    ...
    public String getDeleteConsentCascadeStatements() {

            return  "DELETE FROM FS_CONSENT WHERE CONSENT_ID = ? AND ORG_ID = ?";
