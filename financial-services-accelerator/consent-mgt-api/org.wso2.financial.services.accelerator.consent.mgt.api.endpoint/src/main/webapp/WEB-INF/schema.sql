...
CREATE TABLE IF NOT EXISTS FS_CONSENT_AUTH_RESOURCE (
  ...
  UPDATED_TIME      BIGINT NOT NULL,
  PRIMARY KEY(AUTH_ID),
  CONSTRAINT FK_ID_FS_CONSENT_AUTH_RESOURCE FOREIGN KEY (CONSENT_ID) REFERENCES FS_CONSENT (CONSENT_ID) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS FS_CONSENT_STATUS_AUDIT (
  ...
  CONSTRAINT FK_FS_CONSENT_STATUS_AUDIT FOREIGN KEY (CONSENT_ID) REFERENCES FS_CONSENT (CONSENT_ID) ON DELETE CASCADE
);
