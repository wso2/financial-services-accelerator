...
public class NotificationResponse {
     ...
     * @param notificationResponse Notification Respnse
     * @return JSONObject
     ...
     */
    public static JsonNode getJsonNode(NotificationResponse notificationResponse)
            throws IOException, JOSEException, IdentityOAuth2Exception {
        ObjectMapper objectMapper = new ObjectMapper();
        return objectMapper.convertValue(notificationResponse, JsonNode.class);
    }
