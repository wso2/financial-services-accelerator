...
public class ConsentExpiryValidationFilterPolicy extends FSFilterPolicy {
    ...
    public void processRequest(ServletRequest servletRequest, Map<String, Object> propertyMap)
        ...
        try {
            //TODO: consnet id
            ConsentResource consent = consentCoreService.getConsent(propertyMap.get("consentId").toString(), true);
            if (consent == null) {
                throw new FSPolicyExecutionException(HttpServletResponse.SC_NOT_FOUND,
                        "consent_not_found", "Consent not found");
            }
            long validityPeriod = consent.getValidityPeriod();
    ...
    @Override
    public void processResponse(ServletResponse servletResponse, Map<String, Object> propertyMap) throws FSPolicyExecutionException {
