...
/**
 * Consent validator interface.
 */
public interface ConsentValidator {

    /**
     * Validate function to implement required validations.
     *
     * @param consentValidateData Object with data of the request and consent needed for validations
     * @param consentValidationResult Object to set data with regard to the validation result
