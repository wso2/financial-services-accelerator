...
public class ThriftMetricReporter extends AbstractMetricReporter {
    ...
    @Override
    public void validateConfigProperties(Map<String, String> properties) throws MetricCreationException {
    ...
    @Override
    public CounterMetric createCounter(String name, MetricSchema schema) throws MetricCreationException {
        return new ThriftCounterMetric(name, schema, eventQueue);
    }

    @Override
    public TimerMetric createTimer(String name) {
        return null;
    }
}
