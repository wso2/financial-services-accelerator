 ...
 */
public class FinancialServicesThriftDataPublisherTest {
    ...
    private static final Map<String, Map<Integer, String>> STREAM_ATTRIBUTE_MAP = Stream.of(
            ...
            .collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue));
    FinancialServicesThriftDataPublisher thriftDataPublisher;
    ...
    public void initializeConfigurations() {
        ...
        Mockito.when(financialServicesConfigurationService.getDataPublishingStreams()).thenReturn(STREAM_ATTRIBUTE_MAP);
        ...
        FinancialServicesThriftDataPublisherTest.outContent = new ByteArrayOutputStream();
        FinancialServicesThriftDataPublisherTest.printStream = new PrintStream(
                FinancialServicesThriftDataPublisherTest.outContent);
        System.setOut(FinancialServicesThriftDataPublisherTest.printStream);
        FinancialServicesThriftDataPublisherTest.logger = LogManager.getLogger(
                FinancialServicesThriftDataPublisherTest.class);
    }

    @Test
    public void init() {

        FinancialServicesThriftDataPublisher thriftDataPublisher = new MockedFSThriftDataPublisher();
    ...
    public void tryInitWithoutRequiredConfigs()
        ...
        FSAnalyticsDataHolder.getInstance().
                setFinancialServicesConfigurationService(financialServicesConfigurationService);
        FinancialServicesThriftDataPublisher thriftDataPublisher = Mockito.spy(
                FinancialServicesThriftDataPublisher.class);
        ...
        thriftDataPublisher.init();
        Assert.assertTrue(FinancialServicesThriftDataPublisherTest.outContent.toString().contains(
                "ERROR : Error while retrieving publisher server configs"));
    }

    @Test(priority = 1)
    public void testStreamAttributeMapCreation() {

        thriftDataPublisher = new MockedFSThriftDataPublisher();
    ...
    public void setPayloadWithInvalidBooleanData() {
        ...
        Assert.assertEquals(result, expectedOutput);
        Assert.assertTrue(FinancialServicesThriftDataPublisherTest.outContent.toString().contains(" is expecting a " +
    ...
    public void publish() {
        ...
        Assert.assertFalse(FinancialServicesThriftDataPublisherTest.outContent.toString().contains("ERROR"));
    }
    ...
    public void tryPublishWhenAttributesNotDefined() {
        ...
        Assert.assertTrue(FinancialServicesThriftDataPublisherTest.outContent.toString().contains(
                "ERROR : Error while setting payload to publish data."));
    }

    private class MockedFSThriftDataPublisher extends FinancialServicesThriftDataPublisher {

        private Map<String, Map<String, Object>> validationMap;

        public MockedFSThriftDataPublisher() {
