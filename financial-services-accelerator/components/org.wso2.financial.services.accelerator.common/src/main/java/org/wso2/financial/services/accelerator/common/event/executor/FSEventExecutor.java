...
/**
 * Open banking event executor interface.
 */
public interface FSEventExecutor {

    /**
     * This method is used to process events.
     *
     * @param fsEvent OBEvent which holds event related data
     */
