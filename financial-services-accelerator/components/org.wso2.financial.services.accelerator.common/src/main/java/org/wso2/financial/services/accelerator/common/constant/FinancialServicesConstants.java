...
public class FinancialServicesConstants {
    ...
    public static final String FS_KM_NAME = "KeyManagerName";
    ...
    public static final String FS_CACHE_MANAGER = "FS_CERTIFICATE_CACHE";
    ...
    public static final String FS_IDN_RETRIEVER_SIG_KID = "FSIdentityRetriever.Server.SigningCertificateKid";
    public static final String FS_IDN_RETRIEVER_SANDBOX_KID = "FSIdentityRetriever.Server.SandboxCertificateKid";
    public static final String JWKS_RETRIEVER_SIZE_LIMIT = "FSIdentityRetriever.JWKSRetriever.SizeLimit";
    public static final String JWKS_RETRIEVER_CONN_TIMEOUT = "FSIdentityRetriever.JWKSRetriever.ConnectionTimeout";
    public static final String JWKS_RETRIEVER_READ_TIMEOUT = "FSIdentityRetriever.JWKSRetriever.ReadTimeout";
    ...
    public static final String FS_KEYMANAGER_EXTENSION_IMPL =
            "KeyManager.KeyManagerExtensionImpl";

    //FS Event Notifications Constants
    public static final String TOKEN_ISSUER = "FSEventNotifications.TokenIssuer";
    public static final String MAX_SETS_TO_RETURN = "FSEventNotifications.NumberOfSetsToReturn";
    public static final String SIGNING_ALIAS = "FSEventNotifications.SigningAlias";
    public static final String IS_SUB_CLAIM_INCLUDED = "FSEventNotifications.PollingResponseParams.IsSubClaimAvailable";
    public static final String IS_TXN_CLAIM_INCLUDED = "FSEventNotifications.PollingResponseParams.IsTxnClaimAvailable";
    public static final String IS_TOE_CLAIM_INCLUDED = "FSEventNotifications.PollingResponseParams.IsToeClaimAvailable";
    public static final String EVENT_CREATION_HANDLER = "FSEventNotifications.EventCreationHandler";
    public static final String EVENT_POLLING_HANDLER = "FSEventNotifications.EventPollingHandler";
    public static final String EVENT_SUBSCRIPTION_HANDLER = "FSEventNotifications.EventSubscriptionHandler";
    public static final String EVENT_NOTIFICATION_GENERATOR = "FSEventNotifications.NotificationGenerator";
