...
import org.wso2.financial.services.accelerator.identity.extensions.dcr.validators.DynamicClientRegistrationValidator;
...
public class FSAdditionalAttributeFilter implements AdditionalAttributeFilter {
    ...
    public Map<String, Object> filterDCRRegisterAttributes(ApplicationRegistrationRequest appRegistrationRequest,
        ...
        filteredAttributes.put(IdentityCommonConstants.RESPONSE_TYPES,
                additionalAttributes.get(IdentityCommonConstants.RESPONSE_TYPES));
