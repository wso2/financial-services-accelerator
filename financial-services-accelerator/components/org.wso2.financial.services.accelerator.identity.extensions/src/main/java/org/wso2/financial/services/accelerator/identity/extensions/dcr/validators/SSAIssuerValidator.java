...
public class SSAIssuerValidator implements DynamicClientRegistrationValidator {
    ...
    private static void validateSSAIssuer(Map<String, Object> ssaParams) throws FinancialServicesException {
        ...
        Map<String, Object> configs = configurationService.getDCRValidatorsConfig().get("SSAIssuerValidator");
        List<String> allowedValues = (List<String>) configs.get("AllowedValues");
