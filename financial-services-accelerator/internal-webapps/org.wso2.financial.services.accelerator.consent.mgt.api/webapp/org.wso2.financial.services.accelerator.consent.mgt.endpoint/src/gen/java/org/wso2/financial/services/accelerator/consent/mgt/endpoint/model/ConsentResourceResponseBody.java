...
public ConsentResourceResponseBody() {
    ...
    **/
    ...
    /**
    **/
    public ConsentResourceResponseBody authorizationResources(List<@Valid AuthorizationResourceResponseBody> authorizationResources) {
    ...
    this.authorizationResources = authorizationResources;
        ...
        public ConsentResourceResponseBody addAuthorizationResourcesItem(AuthorizationResourceResponseBody authorizationResourcesItem) {
        ...
        public ConsentResourceResponseBody removeAuthorizationResourcesItem(AuthorizationResourceResponseBody authorizationResourcesItem) {
...
@Override
public int hashCode() {
return Objects.hash(consentId, clientId, consentType, currentStatus, receipt, expiryTime, recurringIndicator, consentAttributes, authorizationResources, createdTime, updatedTime);
}
