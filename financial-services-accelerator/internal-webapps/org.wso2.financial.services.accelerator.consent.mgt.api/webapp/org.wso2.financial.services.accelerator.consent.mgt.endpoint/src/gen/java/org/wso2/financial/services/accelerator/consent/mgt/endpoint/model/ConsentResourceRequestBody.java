...
public ConsentResourceRequestBody() {
    ...
    **/
    ...
    /**
    **/
    public ConsentResourceRequestBody authorizationResources(List<@Valid AuthorizationResourceRequestBody> authorizationResources) {
    ...
    this.authorizationResources = authorizationResources;
        ...
        public ConsentResourceRequestBody addAuthorizationResourcesItem(AuthorizationResourceRequestBody authorizationResourcesItem) {
        ...
        public ConsentResourceRequestBody removeAuthorizationResourcesItem(AuthorizationResourceRequestBody authorizationResourcesItem) {
...
@Override
public int hashCode() {
return Objects.hash(clientId, consentType, currentStatus, receipt, expiryTime, recurringIndicator, consentAttributes, authorizationResources);
}
