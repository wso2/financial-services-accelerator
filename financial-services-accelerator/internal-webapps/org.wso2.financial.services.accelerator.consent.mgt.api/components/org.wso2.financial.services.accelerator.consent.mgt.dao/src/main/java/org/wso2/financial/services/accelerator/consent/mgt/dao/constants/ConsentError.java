...
public enum ConsentError {
    ...
    CONSENT_NOT_FOUND("CMGT_10001", "Consent resource not found", "The requested consent does not exist in the system" +
            "."),
    CONSENT_INSERTION_ERROR("CMGT_10002", "Failed to insert consent resource",
            "Occurs when consent creation logic fails at the service level."),
    CONSENT_INSERTION_ERROR_IN_DATABASE("CMGT_10003", "Failed to persist consent resource to database",
            "Occurs during database operation while storing a new consent."),
    CONSENT_RETRIEVAL_ERROR("CMGT_10004", "Unable to retrieve consent resource", "General error when fetching a " +
            "consent from the service."),
    CONSENT_RETRIEVAL_ERROR_IN_DATABASE("CMGT_10005", "Database error retrieving consent resource", "Occurs due to " +
            "failure at the database layer while fetching a consent."),

    CONSENT_UPDATE_ERROR("CMGT_10006", "Unable to update consent resource", "Occurs when attempting to modify an " +
            "existing consent fails."),
    CONSENT_UPDATE_ERROR_IN_DATABASE("CMGT_10007", "Unable to update consent resource", "Occurs when attempting to " +
            "modify an " +
            "existing consent fails."),
    CONSENT_SEARCH_ERROR("CMGT_10008", "Failed to search for consent resources",
            "An error occurred during the search operation on consents."),
    CONSENT_ALREADY_REVOKED_ERROR("CMGT_10009", "Consent already revoked",
            "Occurs when a consent is already revoked and an attempt is made to revoke it again or to update it."),

    INVALID_CONSENT_EXPIRY_TIME("CMGT_10010", "Invalid consent expiry time",
            "Please ensure that the expiry time is " + "in the" +
                    " future"),
    CONSENT_SEARCH_ERROR_IN_DATABASE("CMGT_10011", "Database error while searching for consent resources",
            "Occurs when the system fails to search for consents in the database."),
    CONSENT_STATUS_UPDATE_ERROR("CMGT_10012", "Unable to update consent status", "Occurs when the system fails to " +
            "update the status of a consent."),
    CONSENT_STATUS_UPDATE_ERROR_IN_DATABASE("CMGT_10013", "Unable to update consent status", "Occurs when the system " +
            "fails to " +
            "update the status of a consent in database."),
    CONSENT_EXPIRY_TIME_UPDATE_ERROR("CMGT_10014", "Unable to update consent validity time",
            "Occurs when the system fails to update the validity time of a consent."),
    CONSENT_EXPIRY_TIME_UPDATE_ERROR_IN_DATABASE("CMGT_10015", "Unable to update consent validity time",
            "Occurs when the system fails to update the validity time of a consent in database."),


    CONSENT_DELETE_ERROR("CMGT_10016", "Unable to delete consent resource",
            "Occurs when the system fails to remove a consent."),

    CONSENT_DELETE_ERROR_IN_DATABASE("CMGT_10017", "Database error while deleting consent resource",
            "Occurs when the system fails to delete a consent from the database."),

    CONSENT_REVOKE_ERROR("CMGT_10018", "Unable to revoke consent resource",
    ...
    AUTHORIZATION_RESOURCE_NOT_FOUND("CMGT_12101", "Authorization resource not found",
            "The requested authorization record could not be located."),
    AUTHORIZATION_RESOURCE_INSERTION_ERROR("CMGT_12002", "Failed to store authorization resource",
            "A general error occurred while saving authorization data."),
    AUTHORIZATION_RESOURCE_INSERTION_ERROR_IN_DATABASE("CMGT_12003",
            "Database error while storing authorization resource",
            "Database insert operation failed for the authorization resource."),
    AUTHORIZATION_RESOURCE_RETRIEVAL_ERROR("CMGT_12004", "Authorization resource not found",
            "The requested authorization resource could not be found."),
    AUTHORIZATION_RESOURCE_RETRIEVAL_ERROR_IN_DATABASE(
            "CMGT_12005", "Database error retrieving authorization resource",
            "Database fetch operation failed for the authorization resource."),
    AUTHORIZATION_RESOURCE_UPDATE_ERROR("CMGT_12006", "Failed to update authorization resource",
    ...
    AUTHORIZATION_RESOURCE_UPDATE_ERROR_IN_DATABASE(
            "CMGT_12007", "Database error while updating authorization resource",
            "Database update operation failed for the authorization resource."),
    AUTHORIZATION_RESOURCE_DELETE_ERROR("CMGT_12308", "Failed to delete authorization resource",
            "Occurs when deletion of the authorization data fails."),

    // Detailed Consent Resource (13)
    DETAILED_CONSENT_NOT_FOUND("CMGT_13001", "Detailed consent resource not found",
            "The system could not find a detailed consent resource for the given identifier."),
    DETAILED_CONSENT_RESOURCE_INSERTION_ERROR("CMGT_13002", "Failed to store detailed consent resource",
            "A general failure occurred while saving a detailed consent record."),
    DETAILED_CONSENT_RESOURCE_INSERTION_ERROR_IN_DATABASE("CMGT_13003",
            "Database error while storing detailed consent resource",
            "Failed to insert a detailed consent record into the database."),
    DETAILED_CONSENT_RETRIEVAL_ERROR("CMGT_13004", "Unable to retrieve detailed consent resource",
            "A general error occurred while fetching a detailed consent."),
    DETAILED_CONSENT_RETRIEVAL_ERROR_IN_DATABASE("CMGT_13005", "Database error retrieving detailed consent resource",
            "Database fetch operation failed for a detailed consent."),
    DETAILED_CONSENT_UPDATE_ERROR("CMGT_13006", "Failed to update detailed consent resource",
            "Occurs when update operation on a detailed consent fails."),

    // status audit (14)

    STATUS_AUDIT_INSERTION_ERROR("CMGT_14002", "Failed to store status audit",
            "A general error occurred while saving status audit data."),
    STATUS_AUDIT_INSERTION_ERROR_IN_DATABASE("CMGT_14003", "Database error while storing status audit",
