...
public enum ConsentError {
    ...
    // dao level
    CONSENT_INSERTION_ERROR("CMGT_10025", "Failed to insert consent resource",
    ...
    CONSENT_UPDATE_ERROR("CMGT_10032", "Unable to update consent resource", "Occurs when attempting to modify an " +
            "existing consent fails."),
    CONSENT_UPDATE_ERROR_IN_DATABASE("CMGT_10033", "Unable to update consent resource", "Occurs when attempting to " +
            "modify an " +
            "existing consent fails."),
    CONSENT_SEARCH_ERROR("CMGT_10034", "Failed to search for consent resources",
            "An error occurred during the search operation on consents."),

    CONSENT_SEARCH_ERROR_IN_DATABASE("CMGT_10035", "Database error while searching for consent resources",
            "Occurs when the system fails to search for consents in the database."),
    CONSENT_STATUS_UPDATE_ERROR("CMGT_10036", "Unable to update consent status", "Occurs when the system fails to " +
            "update the status of a consent."),
    CONSENT_STATUS_UPDATE_ERROR_IN_DATABASE("CMGT_10037", "Unable to update consent status", "Occurs when the system " +
            "fails to " +
            "update the status of a consent in database."),
    CONSENT_EXPIRY_TIME_UPDATE_ERROR("CMGT_10038", "Unable to update consent validity time",
            "Occurs when the system fails to update the validity time of a consent."),
    CONSENT_EXPIRY_TIME_UPDATE_ERROR_IN_DATABASE("CMGT_10042", "Unable to update consent validity time",
    ...
    CONSENT_REVOKE_ERROR("CMGT_10045", "Unable to revoke consent resource",
            "Occurs when the system fails to revoke a consent."),

    //service level
    CONSENT_ALREADY_REVOKED_ERROR("CMGT_10059", "Consent already revoked",
            "Occurs when a consent is already revoked and an attempt is made to revoke it again or to update it."),

    INVALID_CONSENT_EXPIRY_TIME("CMGT_10060", "Invalid consent expiry time",
