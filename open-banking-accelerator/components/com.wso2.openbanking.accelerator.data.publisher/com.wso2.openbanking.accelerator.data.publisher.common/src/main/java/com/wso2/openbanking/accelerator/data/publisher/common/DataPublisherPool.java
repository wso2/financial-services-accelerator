 ...
 * @param <OpenBankingDataPublisher>
 */
public class DataPublisherPool<OpenBankingDataPublisher> extends GenericObjectPool<OpenBankingDataPublisher> {

    public DataPublisherPool(PooledObjectFactory<OpenBankingDataPublisher> factory,
                             GenericObjectPoolConfig<OpenBankingDataPublisher> config) {
