...
/**
 * This class handles throttler DAO layer initiation with the relevant SQL statements per database type.
 */
public class DataStoreInitializer {
    ...
    /**
     * Initialize the DAO according to the database connection.
     *
    ...
    public static synchronized OBThrottlerDAO initializeOBThrottlerDAO() throws OBThrottlerException {
        ...
        if (obThrottlerDAO == null) {
            DataStoreInitializerFactory dataStoreInitializerFactory = new DataStoreInitializerFactory();
            obThrottlerDAO = dataStoreInitializerFactory.initializeDataStore();
        }
        return obThrottlerDAO;
    }
}
