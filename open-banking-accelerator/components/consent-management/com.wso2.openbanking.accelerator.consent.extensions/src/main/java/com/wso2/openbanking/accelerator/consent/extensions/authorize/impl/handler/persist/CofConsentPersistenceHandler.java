...
/**
 * Class to handle COF Consent data persistence for Authorize.
 */
public class CofConsentPersistenceHandler implements ConsentPersistenceHandler {

    private static final Log log = LogFactory.getLog(CofConsentPersistenceHandler.class);
    ...
    public void consentPersist(ConsentPersistData consentPersistData, ConsentResource consentResource)
        ...
        if (!payload.containsKey(ConsentExtensionConstants.COF_ACCOUNT)) {
        ...
        if (!(payload.get(ConsentExtensionConstants.COF_ACCOUNT) instanceof String)) {
