...
/**
 * Class to handle payments Consent data persistence for Authorize.
 */
public class PaymentConsentPersistenceHandler implements ConsentPersistenceHandler {

    private static final Log log = LogFactory.getLog(PaymentConsentPersistenceHandler.class);
