...
/**
 * Annotation class for validating algorithm.
 */
@Target(TYPE)
@Retention(RUNTIME)
@Documented
...
public @interface ValidateAlgorithm {
    ...
    String message() default "Invalid algorithm provided";

    Class<?>[] groups() default {};

    Class<? extends Payload>[] payload() default {};

    String idTokenAlg() default "idTokenAlg";

    String reqObjAlg() default "reqObjAlg";

    String tokenAuthAlg() default "tokenAuthAlg";
